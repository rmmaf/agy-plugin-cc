...
import { getAntigravityAvailability } from "./lib/agy.mjs";
...
function main() {
  ...
  const runningTaskNote = runningJob
    ? `Antigravity task ${runningJob.id} is still running. Check /agy:status and use /agy:cancel ${runningJob.id} if you want to stop it before ending the session.`
    : null;
